...
2. Add equity-history persistence and richer charting/replay views in the frontend.
3. Add funding-history persistence and scheduled funding application for open paper positions.
4. Add docker-compose integration tests or smoke tests that cover API plus frontend together.
5. Investigate the Stitch MCP invalid-argument responses and backfill generated source screens into project `1872692140714476366`.
